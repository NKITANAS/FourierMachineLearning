...
# QML Params (must match train_model_less_data.py)
n_qubits = n_inputs
n_qlayers = 3
...
# =====================================================================================
# QML model: a hybrid quantum-classical network (see train_model_less_data.py for the
